    ...
    () => {
        describe('/Auth', () => {
            ...
            () => {
                ...
                it('/Field  "message" should be contain text "Something went wrong, try again" ',
                    done => {
                        request(app)
                            .post('/auth/register')
                            .send(testData2)
                ...
                it('First field on errors should to be equal "Incorrect email"',
                    done => {
                        request(app)
                            .post('/auth/register')
                            .send(testData)
                ...
                it('Secon field on errors should to be equal "The minimum password length is 10 characters"',
                    done => {
                        request(app)
                            .post('/auth/register')
                            .send(testData)
                            .then( res => {
                                const body = res.body
                                expect(body.errors[1].msg).to.equal('The minimum password length is 10 characters')
                                done()
                            })
                            .catch(err => done(err));
                });
            ...
            describe('/Login user',
                () => {
                    ...
                    it('/Field message to be equal: Incorrect information!',
                        done => {
                            request(app)
                                .post('/auth/login')
                                .send(testData)
                    ...
                    it('Secon field on errors should to be equal "The minimum password length is 6 characters"',
                        done => {
                            request(app)
                                .post('/auth/login')
                                .send(testData)
                                .then( res => {
                                    const body = res.body
                                    expect(body.errors[1].msg).to.equal('The minimum password length is 6 characters')
                                    done()
                                } )
                                .catch(err => done(err));
                });
        ...
        describe("/Courses", () => {
            ...
            describe('Expect no authorization error', () => {
                ...
                it('/If request equal "/common/course/byCategory" and not jwt token fields "message" should be equal "User has no authorization"',
                done => {
                    request(app)
                        .post('/common/course/byCategory')
                        .send(testData)
                ...
                it('/If request equal "/common/course/all" and not jwt token fields "message" should be equal "User has no authorization"',
                done => {
                    request(app)
                        .get('/common/course/all')
                        .then( res => {
                ...
                it('/If request equal "/common/course/category" and not jwt token fields "message" should be equal "User has no authorization"',
                done => {
                    request(app)
                        .get('/common/course/category')
                        .then( res => {
        ...
        describe('/Orders', () => {
            describe('/Orders no authorization error', () => {
                ...
                it('/If request equal "/orders/add" and not jwt token fields "message" should be equal "User has no authorization"',
                    done => {
                        request(app)
                            .post('/orders/add')
                            .send(testData)
                ...
                it('/If request equal "/orders/pay" and not jwt token fields "message" should be equal "User has no authorization"',
                    done => {
                        request(app)
                            .post('/orders/pay')
                            .send(testData)
                ...
                it('/If request equal "/orders/edit" and not jwt token fields "message" should be equal "User has no authorization"',
                    done => {
                        request(app)
                            .post('/orders/edit')
                            .send(testData)
